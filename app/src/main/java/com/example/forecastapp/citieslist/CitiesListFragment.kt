...
import com.example.forecastapp.databinding.FragmentChooseCityBinding
import com.example.forecastapp.datasource.database.CityEntity
import com.example.forecastapp.datasource.database.DataBaseInfo
import com.example.forecastapp.forecast.ForecastFragment
import io.reactivex.Single
import io.reactivex.android.schedulers.AndroidSchedulers
import io.reactivex.disposables.CompositeDisposable
import io.reactivex.schedulers.Schedulers

class CitiesListFragment: Fragment(R.layout.fragment_choose_city),
    CityItemAdapter.OnItemClickListener {
